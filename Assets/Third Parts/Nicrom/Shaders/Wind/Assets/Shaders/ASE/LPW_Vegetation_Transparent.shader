	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 objToWorld1645 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float3 worldToObj1646 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(appendResult1587), 1 ) ).xyz;
				float3 worldToObj1647 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(float3( 0,0,0 )), 1 ) ).xyz;
				...
				float3 objToWorld1649 = GetAbsolutePositionWS(mul( GetObjectToWorldMatrix(), float4( float3( 0,0,0 ), 1 ) ).xyz);
				...
				float MB_RotationAngle97 = radians( ( ( ( ( MB_Amplitude880 + ( MB_AmplitudeOffset1356 * (StaticWorldNoise1340).r ) ) * sin( ( ( ( objToWorld1649.x + objToWorld1649.z ) + ( ( _TimeParameters.x ) * ( MB_Frequency873 + ( MB_FrequencyOffset1474 * (StaticWorldNoise1340).r ) ) ) ) * MB_Phase1360 ) ) ) + MB_DefaultBending877 ) * ( inputMesh.positionOS.y / MB_MaxHeight1335 ) ) );
				float3 appendResult1558 = (float3(0.0 , inputMesh.positionOS.y , 0.0));
				float3 rotatedValue1567 = RotateAroundAxis( appendResult1558, inputMesh.positionOS, MB_RotationAxis1420, MB_RotationAngle97 );
				float3 rotatedValue1565 = RotateAroundAxis( float3( 0,0,0 ), rotatedValue1567, MB_RotationAxis1420, MB_RotationAngle97 );
				float3 LocalVertexOffset1045 = ( ( rotatedValue1565 - inputMesh.positionOS ) * step( 0.01 , inputMesh.positionOS.y ) );
						...
						)
			{
				...
				surfaceDescription.BaseColor = Albedo292.rgb;
...
WireConnection;1655;0;296;0
WireConnection;1655;4;1495;0
WireConnection;1655;7;1496;0
WireConnection;1655;9;1652;0
WireConnection;1655;11;1061;0
ASEEND*/
//CHKSM=4B33744D7EF1193EB62F75EB0B6C9050A555FB04